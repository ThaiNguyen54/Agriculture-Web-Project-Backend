define({ "api": [
  ...
  {
    "type": "GET",
    "url": "/ver1/tags/question/:QuestionID",
    "title": "Get all questions which have a specific tag",
    "version": "1.0.0",
    "name": "GetTagByQuestionID",
    "group": "Tag",
    "permission": [
      {
        "name": "Every type of user"
    ...
    "description": "<p>User use this api to view all questions which have a specific tag</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:3001/ver1/tags/question/:QuestionID",
        "type": "json"
      }
    ],
    "success": {
